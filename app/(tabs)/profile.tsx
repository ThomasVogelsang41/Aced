...
const styles = StyleSheet.create({
  ...
  horizontalScroll: { gap: Spacing.md, paddingBottom: Spacing.md, paddingRight: Spacing.lg },
  recentRoundMiniCard: { width: 160, backgroundColor: Colors.white, borderRadius: BorderRadius.xl, borderWidth: 1, borderColor: Colors.border, padding: Spacing.base, gap: 6, ...Shadows.sm },
  recentMiniCourse: { fontFamily: Typography.fontFamily.bold, fontSize: Typography.size.base },
  recentMiniDate: { color: Colors.secondaryText, fontSize: 11 },
  recentMiniScoreRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10 },
  miniDiffBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: BorderRadius.md },
  miniDiffText: { fontFamily: Typography.fontFamily.bold, fontSize: 14 },
  miniScoreVal: { fontFamily: Typography.fontFamily.bold, fontSize: 20 },
